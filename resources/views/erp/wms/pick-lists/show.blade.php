                    ...
                    <div class="datagrid">
                        <div class="datagrid-item">
                            ...
                            <div class="datagrid-content font-weight-medium">
                                <a href="{{ route('erp.orders.show', $pickList->order_id) }}">
                                    {{ optional($pickList->order)->order_number ?? '-' }}
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="datagrid-item">
                            ...
                            <div class="datagrid-content">
                                {{ optional(optional($pickList->order)->party)->name ?? '-' }}
                            </div>
                        </div>
                        ...
                        <div class="datagrid-item">
                            ...
                            <div class="datagrid-content">
                                {{ optional($pickList->warehouse)->name ?? '-' }}
                            </div>
                        </div>
                            ...
                            <div class="datagrid-content">
                                @if($pickList->assignedTo)
                                    <div class="d-flex align-items-center">
                                        <span class="avatar avatar-xs me-2 rounded bg-blue-lt text-uppercase">
                                            {{ substr($pickList->assignedTo->name, 0, 1) }}
                                        </span>
                        ...
                        <div class="datagrid-item">
                            ...
                            <div class="datagrid-content">
                                ...
                                <span class="badge {{ $cls }} text-uppercase">
                                    {{ str_replace('_',' ',$pickList->status) }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="datagrid-item">
                            ...
                            <div class="datagrid-content">
                                {{ $pickList->started_at?->format('d M Y, H:i') ?? '—' }}
                            </div>
                        </div>
                        ...
                        <div class="datagrid-item">
                            ...
                            <div class="datagrid-content">
                                {{ $pickList->completed_at?->format('d M Y, H:i') ?? '—' }}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-vcenter card-table table-striped">
                        ...
                        <tbody>
                            ...
                            @php
                                $remaining = max(0, $item->requested_qty - $item->picked_qty);
                            @endphp
                            <tr>
                                <td>
                                    ...
                                    <div class="text-muted small">
                                        Batch: {{ optional($item->batch)->batch_no ?? '—' }}
                                    </div>
                                </td>
