    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Picking Tasks</h2>
            </div>
    ...
    <div class="container-xl">
        ...
        <div class="card">
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap g-3">
                    <div class="d-flex align-items-center flex-wrap g-2">
                        ...
                        <select class="form-select form-select-sm w-auto me-2" id="bulk-action-select">
                            ...
                            <option value="assign">Assign Operator</option>
                        </select>
                        ...
                        <div class="input-icon">
                            ...
                            <input type="text" id="ajax-search" class="form-control form-control-sm" placeholder="Search Task #, Order #, Party..." value="{{ request('search') }}">
                        </div>
                    </div>
                    ...
                    <div class="d-flex align-items-center flex-wrap g-2">
                        <select id="status-filter" class="form-select form-select-sm w-auto me-2">
                            ...
                            @foreach(['pending'=>'Pending','in_progress'=>'In Progress','completed'=>'Completed','cancelled'=>'Cancelled'] as $s => $label)
            ...
            <div id="table-container">
                @include('erp.wms.pick-lists._table')
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchPickLists(url = null) {
        if (!url) {
    ...
    if (searchInput) {
        searchInput.addEventListener('input', function () {
            ...
            searchTimeout = setTimeout(() => fetchPickLists(), 500);
        });
    }

    // Filters
    if (warehouseFilter) {
        warehouseFilter.addEventListener('change', () => fetchPickLists());
    }
    if (statusFilter) {
        statusFilter.addEventListener('change', () => fetchPickLists());
    }
    ...
    tableContainer.addEventListener('change', function(e) {
        if (e.target && e.target.id === 'select-all') {
            ...
            tableContainer.querySelectorAll('.task-checkbox').forEach(cb => {
