            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('erp.wms.dashboard') }}" class="btn btn-outline-secondary d-none d-sm-inline-block">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-layout-dashboard" width="24" height="24" viewBox="0 0 24 24">
                            <path d="M4 4h6v8h-6z" /><path d="M4 16h6v4h-6z" /><path d="M14 12h6v8h-6z" /><path d="M14 4h6v6h-6z" />
                        </svg>
                        Logistics Hub
                    </a>
                </div>
                    ...
                    <div class="input-icon">
                        <span class="input-icon-addon">
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24">
                                <path d="M10 10m-7 0a7 7 0 1 0 14 0" /><path d="M21 21l-6 -6" />
                            </svg>
                        </span>
                        <input type="text" id="ajax-search" class="form-control form-control-sm"
                               placeholder="Search Order #, Party..." value="{{ request('search') }}">
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (warehouseFilter) warehouseFilter.addEventListener('change', fetchPackingQueue);
    if (statusFilter) statusFilter.addEventListener('change', fetchPackingQueue);

    // ✅ FIX: robust pagination
    ...
    tableContainer.addEventListener('change', function(e) {
        if (e.target?.id === 'select-all') {
            ...
            tableContainer.querySelectorAll('.order-checkbox')
