                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-end shadow-sm">
                                ...
                                @else
                                    ...
                                    @if($order->invoice)
                                        <a class="dropdown-item" href="{{ route('erp.invoices.show', $order->invoice->id) }}">
                                    ...
                                    @elseif(in_array($order->status, ['packed', 'shipped', 'in_transit', 'delivered', 'completed', 'closed']))
                                        <a class="dropdown-item" href="{{ route('erp.invoices.create', ['order_id' => $order->id]) }}">
