    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                ...
                <h2 class="page-title">Create Shipment for {{ $order->order_number }}</h2>
            </div>
        </div>
    </div>
</div>
<div class="page-body">
    <div class="container-xl">
        <div class="card col-lg-7 mx-auto">
            ...
            <form method="POST" action="{{ route('erp.shipments.store', $order) }}">
                @csrf
                <div class="card-body">
                    @if($errors->any())
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="carrier" class="form-control" value="{{ old('carrier') }}" placeholder="DHL, FedEx, India Post..." required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="tracking_url" class="form-control" value="{{ old('tracking_url') }}" placeholder="https://...">
                    </div>
                    <div class="mb-3">
                ...
                <div class="card-footer d-flex">
                    <a href="{{ route('erp.orders.show', $order) }}" class="btn btn-ghost">Cancel</a>
                    <button type="submit" class="btn btn-primary ms-auto">Create Shipment & Ship Order</button>
                </div>
            </form>
        </div>
    </div>
