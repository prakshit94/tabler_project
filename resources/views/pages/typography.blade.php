                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            ...
                            <div class="dropdown-menu-column">
                              ...
                              <a class="dropdown-item active" href="/typography" aria-current="page"> Typography </a>
                            </div>
                          </div>
                        </div>
                      </li>
              ...
              <div class="card-body">
                <div class="row g-4">
                  <div class="col-12 prose">
                    <h1>1/1 Text</h1>
                    <p>
                      I'm not a witch. Now, look here, my good man. Oh! Come and see the violence inherent in the system! Help, help, I'm being repressed! Well,
                      I didn't vote for you. You can't expect to wield supreme power just 'cause some watery tart threw a sword at you! Bring her forward! He
                      hasn't got shit all over him. He hasn't got shit all over him. We shall say 'Ni' again to you, if you do not appease us.
                    </p>
                  ...
                  <div class="col-md-6 prose">
                    <h2>1/2 Text</h2>
                    <p>
                      What do you mean? We shall say 'Ni' again to you, if you do not appease us. I have to push the pram a lot. No, no, no! Yes, yes. A bit.
                      But she's got a wart. What a strange person.
                    </p>
                  </div>
                  <div class="col-md-6 prose">
                    <h2>1/2 Text</h2>
                    <p>
                      And this isn't my nose. This is a false one. We found them. Listen. Strange women lying in ponds distributing swords is no basis for a
                      system of government. Supreme executive power derives from a mandate from the masses, not from some farcical aquatic ceremony.
                    </p>
                  </div>
                  <div class="col-md-4 prose">
                    <h3>1/3 Text</h3>
                    <p>
                      Knights of Ni, we are but simple travelers who seek the enchanter who lives beyond these woods. Why? Well, what do you want? …Are you
                      suggesting that coconuts migrate?
                    </p>
                  </div>
                  <div class="col-md-8 prose">
                    <h3>2/3 Text</h3>
                    <p>
                      Well, I got better. Knights of Ni, we are but simple travelers who seek the enchanter who lives beyond these woods. Found them? In
                      Mercia?! The coconut's tropical! A newt? …Are you suggesting that coconuts migrate?
                    </p>
                  </div>
                  <div class="col-md-8 prose">
                    <p>
                      ...
                      hamster and your father smelt of elderberries! Now leave before I am forced to taunt you a second time! We want a shrubbery!!
                    </p>
                  ...
                  <div class="col-12 prose">
                    ...
                    <blockquote class="blockquote">
                      <p>
                        I don't want to talk to you no more, you empty-headed animal food trough water! I fart in your general direction! Your mother was a
                        hamster and your father smelt of elderberries! Now leave before I am forced to taunt you a second time! The nose?
                      </p>
                  ...
                  <div class="col-md-4 prose">
                    ...
                    <address>
                      <strong>Full name <br /></strong><a href="mailto:#">first.last@example.com</a>
                    </address>
                  </div>
                  <div class="col-md-4 prose">
                    <h3>Typography</h3>
