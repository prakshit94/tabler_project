...
<html lang="en">
  <head>
    ...
    <title>All Elements - Kitchen Sink - Tabler - Premium and Open Source dashboard template with responsive and high quality UI.</title>
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="/tabler/dist/libs/nouislider/dist/nouislider.min.css?1777289127" rel="stylesheet" />
    <link href="/tabler/dist/libs/tom-select/dist/css/tom-select.bootstrap5.min.css?1777289127" rel="stylesheet" />
    <link href="/tabler/dist/libs/star-rating.js/dist/star-rating.min.css?1777289127" rel="stylesheet" />
                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                              <a class="dropdown-item active" href="/all-elements" aria-current="page"> All Elements </a>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="btn-list mb-3">
                          <a href="#" class="btn btn-1"> Default </a>
                          ...
                          <a href="#" class="btn btn-secondary btn-2"> Secondary </a>
                          <a href="#" class="btn btn-success btn-3">
                          ...
                          <a href="#" class="btn btn-warning btn-2"> Warning </a>
                          <a href="#" class="btn btn-danger btn-3">
                          ...
                          <a href="#" class="btn btn-info btn-2"> Info </a>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <h4>Button Sizes</h4>
                    ...
                    <div class="space-y">
                      ...
                      <div>
                        <span class="badge bg-primary text-primary-fg"
                          ...
                          >With Icon</span
                        >
                        <span class="badge bg-primary-lt text-primary-lt-fg">Light Badge</span>
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="mb-3">
                          ...
                          <select class="form-select" id="select-demo-select" value="">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="mb-3">
                          ...
                          <label class="form-check">
                            <input class="form-check-input" type="radio" name="radio-demo" />
                            <span class="form-check-label">Option 1</span>
                          </label>
                          <label class="form-check">
                            <input class="form-check-input" type="radio" name="radio-demo" checked />
                            <span class="form-check-label">Option 2</span>
                          </label>
                        </div>
                        <div class="mb-3">
                      ...
                      <table class="table table-vcenter">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><span class="badge bg-success text-success-fg">Active</span></td>
                          </tr>
                          <tr>
                            <td>Jane Smith</td>
                            <td>jane@example.com</td>
                            <td><span class="badge bg-warning text-warning-fg">Pending</span></td>
                          </tr>
                          <tr>
                            <td>Bob Johnson</td>
                            <td>bob@example.com</td>
                            <td><span class="badge bg-danger text-danger-fg">Inactive</span></td>
                          </tr>
                        </tbody>
                      </table>
                    </div>
                  ...
                  <div class="card-body">
                    <div class="space-y">
                      <div>
                        ...
                        <span class="avatar avatar-1"> JS </span>
                        <span class="avatar avatar-lg"> BJ </span>
                        <span class="avatar avatar-xl"> AB </span>
                      </div>
                      <div>
                        <span class="avatar avatar-2 avatar-avatar-rounded"> RD </span>
                        <span class="avatar avatar-3 avatar-avatar-rounded bg-primary-lt"> PR </span>
                        <span class="avatar avatar-3 avatar-avatar-rounded bg-success-lt"> SC </span>
                      </div>
                      <div>
                        ...
                        <span class="avatar avatar-2 bg-warning-lt">
                          <!-- Download SVG icon from http://tabler.io/icons/icon/star -->
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="btn-list">
                      <div class="dropdown">
                        <a href="#" class="btn dropdown-toggle" data-bs-toggle="dropdown">Primary Dropdown</a>
                        <div class="dropdown-menu">
                      ...
                      <div class="dropdown">
                        <a href="#" class="btn dropdown-toggle" data-bs-toggle="dropdown">Secondary Dropdown</a>
                        <div class="dropdown-menu">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-6">
                        <h4>Accordion</h4>
                        <div class="mb-4">
                          <div class="accordion" id="accordion-demo-accordion">
                            <div class="accordion-item">
                              <div class="accordion-header">
                                <button
                                  ...
                                  type="button"
                                  data-bs-toggle="collapse"
                                  data-bs-target="#collapse-1-demo-accordion"
                                  aria-expanded="true"
                                >
                              ...
                              <div id="collapse-1-demo-accordion" class="accordion-collapse collapse show" data-bs-parent="#accordion-demo-accordion">
                            ...
                            <div class="accordion-item">
                              <div class="accordion-header">
                                <button
                                  ...
                                  type="button"
                                  data-bs-toggle="collapse"
                                  data-bs-target="#collapse-2-demo-accordion"
                                  aria-expanded="false"
                                >
                              ...
                              <div id="collapse-2-demo-accordion" class="accordion-collapse collapse" data-bs-parent="#accordion-demo-accordion">
                                <div class="accordion-body">
                            ...
                            <div class="accordion-item">
                              <div class="accordion-header">
                                <button
                                  ...
                                  type="button"
                                  data-bs-toggle="collapse"
                                  data-bs-target="#collapse-3-demo-accordion"
                                  aria-expanded="false"
                                >
                              ...
                              <div id="collapse-3-demo-accordion" class="accordion-collapse collapse" data-bs-parent="#accordion-demo-accordion">
                                <div class="accordion-body">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="mb-3">
                          <div class="d-flex flex-wrap gap-2">
                            <div class="spinner-border text-primary spinner-border-2" role="status"></div>
                            <div class="spinner-border text-success spinner-border-sm" role="status"></div>
                            <div class="spinner-grow text-warning spinner-grow-2" role="status"></div>
                            <div class="spinner-grow text-danger spinner-grow-sm" role="status"></div>
                          </div>
                        </div>
                        <h4>Rating</h4>
                        <div class="mb-3">
                          <select id="rating-demo-rating">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-3">
                      ...
                      <span class="status-dot status-info status-dot-animated"></span>
                    </div>
                    <h4>Toast Notifications</h4>
                    <div class="mb-3">
                      <div class="toast show" id="toast-demo-toast" role="alert" aria-live="assertive" aria-atomic="true" data-bs-autohide="false">
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-3">
                      <div class="input-group">
                        <span class="input-group-text"> $ </span>
                        <input type="text" class="form-control" placeholder="Price" autocomplete="off" />
                        <span class="input-group-text"> .00 </span>
                      </div>
                    </div>
                    <h4>Range Slider</h4>
                    <div class="mb-3">
                      <div class="form-range mb-2" id="range-demo-range"></div>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-3">
                      ...
                      <span class="tag">
                        <span class="badge bg-success text-success-fg tag-status badge-dot"></span>
                        Success Tag
                        <a href="#" class="btn-close"></a>
                      </span>
                      <span class="tag">
                        <span class="badge bg-warning text-warning-fg tag-status badge-dot"></span>
                        Warning Tag
                        <a href="#" class="btn-close"></a>
                      </span>
                    </div>
                    ...
                    <div class="position-relative mb-3" style="height: 100px; background: #f8f9fa; border-radius: 8px">
                      <div class="ribbon ribbon-top bg-danger">Sale</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-3">
                      <div class="d-flex flex-wrap gap-2">
                        <span class="flag flag-1 flag-country-us"></span>
                        <span class="flag flag-1 flag-country-gb"></span>
                        <span class="flag flag-1 flag-country-de"></span>
                        <span class="flag flag-1 flag-country-fr"></span>
                        <span class="flag flag-1 flag-country-pl"></span>
                        <span class="flag flag-1 flag-country-es"></span>
                        <span class="flag flag-1 flag-country-it"></span>
                        <span class="flag flag-1 flag-country-nl"></span>
                        <span class="flag flag-1 flag-country-ca"></span>
                        <span class="flag flag-1 flag-country-au"></span>
                      </div>
                    </div>
                    <h4>Payment Icons</h4>
                    <div class="mb-3">
                      <div class="d-flex flex-wrap gap-2">
                        <span class="payment payment-1 payment-provider-visa"></span>
                        <span class="payment payment-1 payment-provider-mastercard"></span>
                        <span class="payment payment-1 payment-provider-paypal"></span>
                        <span class="payment payment-1 payment-provider-americanexpress"></span>
                        <span class="payment payment-1 payment-provider-applepay"></span>
                        <span class="payment payment-1 payment-provider-google-pay"></span>
                        <span class="payment payment-1 payment-provider-stripe"></span>
                        <span class="payment payment-1 payment-provider-discover"></span>
                        <span class="payment payment-1 payment-provider-jcb"></span>
                        <span class="payment payment-1 payment-provider-maestro"></span>
                        <span class="payment payment-1 payment-provider-dinersclub"></span>
                        <span class="payment payment-1 payment-provider-bitcoin"></span>
                        <span class="payment payment-1 payment-provider-ethereum"></span>
                        <span class="payment payment-1 payment-provider-klarna"></span>
                        <span class="payment payment-1 payment-provider-venmo"></span>
                        <span class="payment payment-1 payment-provider-square"></span>
                      </div>
                    </div>
                  </div>
                </div>
                            ...
                            <div class="mt-3">
                              <div class="row g-2">
                                <div class="col-4">
                                  <!-- Photo -->
                                  <img
                                    src="/tabler/static/photos/blue-sofa-with-pillows-in-a-designer-living-room-interior.jpg"
                                    class="rounded"
                                ...
                                <div class="col-4">
                                  <!-- Photo -->
                                  <img
                                    src="/tabler/static/photos/home-office-desk-with-macbook-iphone-calendar-watch-and-organizer.jpg"
                                    class="rounded"
                                ...
                                <div class="col-4">
                                  <!-- Photo -->
                                  <img src="/tabler/static/photos/young-woman-working-in-a-cafe.jpg" class="rounded" alt="Young woman working in a cafe" />
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="modal-content">
                          <div class="modal-body text-center py-4">
                            ...
                            <svg
                              ...
                              aria-hidden="true"
                              focusable="false"
                              class="icon mb-2 text-success icon-xl"
                            >
                              <path d="M3 12a9 9 0 1 0 18 0a9 9 0 1 0 -18 0" />
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-3">
                      <nav class="nav nav-segmented nav-1" role="tablist">
                        <button class="nav-link active" role="tab" data-bs-toggle="tab" aria-selected="true" aria-current="page">Home</button>
                        <button class="nav-link" role="tab" data-bs-toggle="tab" aria-selected="false">Profile</button>
                        <button class="nav-link" role="tab" data-bs-toggle="tab" aria-selected="false">Settings</button>
                      </nav>
                    </div>
                    <h4>With Icons</h4>
                    <div class="mb-3">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="btn-list">
                          <button
                            ...
                            title="Popover Title"
                            data-bs-content="This is popover content on top"
                          >
                            Top Popover
                          </button>
                          <button
                            ...
                            title="Popover Title"
                            data-bs-content="This is popover content on right"
                          >
                            Right Popover
                          </button>
                        </div>
...
function greetUser(name) {
   ...
   return true;
    ...
    <script src="/tabler/dist/libs/nouislider/dist/nouislider.min.js?1777289128" defer></script>
    <script src="/tabler/dist/libs/tom-select/dist/js/tom-select.base.min.js?1777289128" defer></script>
    <script src="/tabler/dist/libs/star-rating.js/dist/star-rating.min.js?1777289128" defer></script>
    <!-- END PAGE LIBRARIES -->
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        var el;
        window.TomSelect &&
          new TomSelect((el = document.getElementById("select-demo-select")), {
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        const rating = new StarRating("#rating-demo-rating", {
          tooltip: false,
          clearable: false,
          stars: function (el, item, index) {
            el.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" focusable="false" class="icon gl-star-full icon-2"><path d="M8.243 7.34l-6.38 .925l-.113 .023a1 1 0 0 0 -.44 1.684l4.622 4.499l-1.09 6.355l-.013 .11a1 1 0 0 0 1.464 .944l5.706 -3l5.693 3l.1 .046a1 1 0 0 0 1.352 -1.1l-1.091 -6.355l4.624 -4.5l.078 -.085a1 1 0 0 0 -.633 -1.62l-6.38 -.926l-2.852 -5.78a1 1 0 0 0 -1.794 0l-2.853 5.78z" /></svg>`;
          },
          classNames: {},
        });
      });
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.noUiSlider &&
          noUiSlider.create(document.getElementById("range-demo-range"), {
            start: 50,
            step: 10,
            range: {
              min: 0,
