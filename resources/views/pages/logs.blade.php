                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                              ...
                              <a class="dropdown-item active" href="/logs" aria-current="page"> Logs </a>
...
2024-01-15 14:23:51 [DEBUG] API request completed: endpoint=/api/users, duration=234ms</code></pre>
                    ...
                    <div>
                      <div class="mb-2">
                        <span class="badge bg-success text-success-fg">INFO</span>
                        <span class="badge bg-warning text-warning-fg">WARNING</span>
                        <span class="badge bg-disabled text-disabled-fg">ERROR</span>
                        <span class="badge bg-disabled text-disabled-fg">DEBUG</span>
                      </div>
                    </div>
                  </div>
                  <div class="card-footer">
