...
<html lang="en">
  <head>
    ...
    <title>Patterns - Tabler - Premium and Open Source dashboard template with responsive and high quality UI.</title>
                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            ...
                            <div class="dropdown-menu-column">
                              ...
                              <a class="dropdown-item active" href="/patterns" aria-current="page">
                                Patterns
                                <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                              </a>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-6 g-3">
                      <div class="col">
                        <div class="bg-pattern-diagonal rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-diagonal</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-diagonal-2 rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-diagonal-2</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-dots rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-dots</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-rectangles</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-lines rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-lines</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-lines-vertical rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-lines-vertical</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-grid rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-grid</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-grid-diagonal rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-grid-diagonal</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-blueprint rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-blueprint</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-circles rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-circles</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-diagonal-stripes rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-diagonal-stripes</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-diagonal-stripes-2 rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-diagonal-stripes-2</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-zigzag rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-zigzag</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-vertical-stripes rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-vertical-stripes</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-horizontal-stripes rounded mb-3" style="height: 8rem"></div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-6 g-3">
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-blue rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-blue</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-azure rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-azure</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-indigo rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-indigo</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-purple rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-purple</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-pink rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-pink</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-red rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-red</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-orange rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-orange</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-yellow rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-yellow</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-lime rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-lime</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-green rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-green</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-teal rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-teal</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-rectangles bg-pattern-cyan rounded mb-3" style="height: 8rem"></div>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-6 g-3">
                      <div class="col">
                        <div class="bg-pattern-diagonal bg-pattern-sm rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-sm</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-diagonal bg-pattern-md rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-md</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-diagonal bg-pattern-lg rounded mb-3" style="height: 8rem"></div>
                        <code>.bg-pattern-lg</code>
                      </div>
                      <div class="col">
                        <div class="bg-pattern-diagonal bg-pattern-xl rounded mb-3" style="height: 8rem"></div>
