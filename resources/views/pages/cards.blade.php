            ...
            <div class="row row-cards">
                ...
                <div class="card">
                  <div class="row row-0">
                    <div class="col-3">
                      <!-- Photo -->
                      <img
                        src="/tabler/static/photos/beautiful-blonde-woman-relaxing-with-a-can-of-coke-on-a-tree-stump-by-the-beach.jpg"
                ...
                <div class="card">
                  <div class="row row-0">
                    <div class="col-3 order-md-last">
                      <!-- Photo -->
                      <img
                        src="/tabler/static/photos/finances-us-dollars-and-bitcoins-currency-money.jpg"
              ...
              <div class="col-md-6 col-lg-4">
                ...
                <div class="card-tabs">
                  ...
                  <ul class="nav nav-tabs">
                    <li class="nav-item"><a href="#tab-top-1" class="nav-link active" data-bs-toggle="tab">Activity</a></li>
                    <li class="nav-item"><a href="#tab-top-2" class="nav-link" data-bs-toggle="tab">Profile</a></li>
                    <li class="nav-item"><a href="#tab-top-3" class="nav-link" data-bs-toggle="tab">Settings</a></li>
                  </ul>
                  <div class="tab-content">
                    <!-- Content of card #Activity -->
              ...
              <div class="col-md-6 col-lg-4">
                ...
                <div class="card-tabs">
                  ...
                  <ul class="nav nav-tabs nav-tabs-bottom">
                    <li class="nav-item"><a href="#tab-bottom-1" class="nav-link active" data-bs-toggle="tab">Activity</a></li>
                    <li class="nav-item"><a href="#tab-bottom-2" class="nav-link" data-bs-toggle="tab">Profile</a></li>
                    <li class="nav-item"><a href="#tab-bottom-3" class="nav-link" data-bs-toggle="tab">Settings</a></li>
                  </ul>
                </div>
              </div>
              <div class="col-12">
              ...
              <div class="col-lg-4">
                <div class="card">
                  <div class="empty">
                    <div class="empty-img">
                      <svg class="img" xmlns="http://www.w3.org/2000/svg" height="160" fill="none" viewBox="0 0 800 600">
                        <style>
              ...
              <div class="col-lg-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div class="mt-2">
                      <a href="#" class="btn btn-primary btn-3 w-100"> Pay now </a>
                    </div>
                  </div>
                </div>
              </div>
