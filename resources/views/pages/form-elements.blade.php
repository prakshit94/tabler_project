                  ...
                  <nav aria-label="Primary">
                    ...
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item active" href="/form-elements" aria-current="page"> Form elements </a>
                              ...
                              <div class="row g-2">
                                ...
                                <div class="col-6 col-sm-4">
                                  <label class="form-imagecheck mb-2">
                                    ...
                                    <span class="form-imagecheck-figure">
                                      <img
                                        src="/tabler/static/photos/brainstorming-session-with-creative-designers.jpg"
                                ...
                                <div class="col-6 col-sm-4">
                                  <label class="form-imagecheck mb-2">
                                    ...
                                    <span class="form-imagecheck-figure">
                                      <img
                                        src="/tabler/static/photos/group-of-people-brainstorming-and-taking-notes-2.jpg"
                              ...
                              <div class="row g-2">
                                <div class="col-6 col-sm-4">
                                  <label class="form-imagecheck mb-2">
                                    ...
                                    <span class="form-imagecheck-figure">
                                      <img
                                        src="/tabler/static/photos/group-of-people-sightseeing-in-the-city.jpg"
                                ...
                                <div class="col-6 col-sm-4">
                                  <label class="form-imagecheck mb-2">
                                    ...
                                    <span class="form-imagecheck-figure">
                                      <img
                                        src="/tabler/static/photos/stylish-workplace-with-computer-at-home.jpg"
                                ...
                                <div class="col-6 col-sm-4">
                                  <label class="form-imagecheck mb-2">
                                    ...
                                    <span class="form-imagecheck-figure">
                                      <img
                                        src="/tabler/static/photos/pink-desk-in-the-home-office.jpg"
                                ...
                                <div class="col-6 col-sm-4">
                                  <label class="form-imagecheck mb-2">
                                    ...
                                    <span class="form-imagecheck-figure">
                                      <img
                                        src="/tabler/static/photos/young-woman-sitting-on-the-sofa-and-working-on-her-laptop.jpg"
                                ...
                                <div class="col-6 col-sm-4">
                                  <label class="form-imagecheck mb-2">
                                    ...
                                    <span class="form-imagecheck-figure">
                                      <img
                                        src="/tabler/static/photos/coffee-on-a-table-with-other-items.jpg"
                                ...
                                <label class="form-selectgroup-item">
                                  ...
                                  <span class="form-selectgroup-label"
                                    ...
                                    <svg
                                      ...
                                      class="icon icon-3"
                                    >
                                      <path d="M12 3c.132 0 .263 0 .393 0a7.5 7.5 0 0 0 7.92 12.446a9 9 0 1 1 -8.313 -12.454l0 .008" /></svg
                                  ></span>
                                </label>
                                <label class="form-selectgroup-item">
                              ...
                              <div class="form-selectgroup form-selectgroup-boxes d-flex flex-column">
                                <label class="form-selectgroup-item flex-fill">
                                  ...
                                  <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    ...
                                    <div class="form-selectgroup-label-content d-flex align-items-center">
                                      <span class="avatar avatar-2 me-3" style="background-image: url(./static/avatars/000m.jpg)"> </span>
                                      <div>
                                ...
                                <label class="form-selectgroup-item flex-fill">
                                  ...
                                  <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    ...
                                    <div class="form-selectgroup-label-content d-flex align-items-center">
                                      <span class="avatar avatar-2 me-3" style="background-image: url(./static/avatars/002m.jpg)"> </span>
                                      <div>
                                ...
                                <label class="form-selectgroup-item flex-fill">
                                  ...
                                  <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    ...
                                    <div class="form-selectgroup-label-content d-flex align-items-center">
                                      <span class="avatar avatar-2 me-3" style="background-image: url(./static/avatars/003m.jpg)"> </span>
                                      <div>
                                ...
                                <label class="form-selectgroup-item flex-fill">
                                  ...
                                  <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    ...
                                    <div class="form-selectgroup-label-content d-flex align-items-center">
                                      <span class="avatar avatar-2 me-3" style="background-image: url(./static/avatars/000f.jpg)"> </span>
                                      <div>
                            ...
                            <div class="mb-3">
                              ...
                              <div class="btn-group w-100" role="group">
                                ...
                                <div class="btn-group" role="group">
                                  ...
                                  <label
                                    for="btn-radio-dropdown-dropdown"
                                  ...
                                  <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item" href="#"> Option 6dropdown-menu </a>
                                  </div>
                                </div>
                              </div>
                            </div>
...
But that's the difference in our opinions.</textarea
    ...
    <script src="/tabler/dist/libs/imask/dist/imask.min.js?1777289128" defer></script>
    <script src="/tabler/dist/libs/autosize/dist/autosize.min.js?1777289128" defer></script>
