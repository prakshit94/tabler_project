                ...
                <div class="col-12 col-md-3 border-end">
                  <div class="card-body">
                    ...
                    <nav class="list-group list-group-transparent">
                      <a href="/settings" class="list-group-item list-group-item-action d-flex align-items-center active">My Account</a>
                      ...
                      <a href="/settings-plan" class="list-group-item list-group-item-action d-flex align-items-center">Plans</a>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row g-3">
                      <div class="col-md">
                        ...
                        <input type="text" class="form-control" id="business-name" name="business-name" value="Tabler" />
                      </div>
                      <div class="col-md">
                      ...
                      <div class="col-md">
                        ...
                        <input type="text" class="form-control" id="location" name="location" value="Peimei, China" />
                      </div>
                    </div>
                    ...
                    <div>
                      <div class="row g-2">
                        <div class="col-auto">
                          ...
                          <input type="text" class="form-control w-auto" id="email" name="email" value="paweluna@howstuffworks.com" />
                        </div>
                        <div class="col-auto">
