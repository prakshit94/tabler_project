  ...
  <body>
                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            ...
                            <div class="dropdown-menu-column">
                              ...
                              <a class="dropdown-item active" href="/widgets" aria-current="page"> Widgets </a>
          ...
          <div class="container-xl">
            <div class="row row-cards">
              <div class="col-12 col-md-6 col-xxl-3 mb-4 mb-xxl-0">
                <div class="card">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                        <h4 class="subheader mb-1">Earned</h4>
                        <div class="h3 m-0">$2,847</div>
                      </div>
                      <div class="col-auto">
              ...
              <div class="col-12 col-md-6 col-xxl-3 mb-4 mb-xxl-0">
                <div class="card">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                        <h4 class="subheader mb-1">Hours logged</h4>
                        <div class="h3 m-0">42.7 hrs</div>
                      </div>
                      <div class="col-auto">
                        <span class="avatar avatar-lg">
              ...
              <div class="col-12 col-md-6 col-xxl-3 mb-4 mb-md-0">
                <div class="card">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                        <h4 class="subheader mb-1">Avg. time</h4>
                        <div class="h3 m-0">3:28 hrs</div>
                      </div>
                      <div class="col-auto">
                        <span class="avatar avatar-lg">
                          <!-- Download SVG icon from http://tabler.io/icons/icon/slideshow -->
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
              ...
              <div class="col-12 col-md-6 col-xxl-3">
                <div class="card">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col">
                        <h4 class="subheader mb-1">Weekly growth</h4>
                        <div class="h3 m-0">18.4%</div>
                      </div>
                      <div class="col-auto">
                        <span class="avatar avatar-lg">
                          <!-- Download SVG icon from http://tabler.io/icons/icon/discount -->
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
              ...
              <div class="col-md-6 col-xl-3">
                <a class="card card-link" href="#">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-auto">
                        <span class="avatar avatar-2 rounded" style="background-image: url(./static/avatars/001f.jpg)"> </span>
                      </div>
                      <div class="col">
                        <div class="fw-medium">Maryjo Lebarree</div>
              ...
              <div class="col-md-6 col-xl-3">
                <a class="card card-link" href="#">
                  <div class="card-body">
                    <div class="row">
                      <div class="col-auto">
                        <span class="avatar avatar-2 rounded" style="background-image: url(./static/avatars/004m.jpg)"> </span>
                      </div>
                      <div class="col">
              ...
              <div class="col-md-6 col-xl-3">
                <a class="card card-link" href="#">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <div class="fw-medium">Kellie Skingley</div>
              ...
              <div class="col-md-6 col-xl-3">
                <a class="card card-link" href="#">
                  <div class="card-body">
                    <div class="row">
                      <div class="col">
                        <div class="fw-medium">Christabel Charlwood</div>
                        <div class="text-secondary">Tax Accountant</div>
                      </div>
                      <div class="col-auto">
                        <span class="avatar avatar-2 rounded" style="background-image: url(./static/avatars/003f.jpg)"> </span>
                      </div>
                    </div>
                  </div>
                </a>
              ...
              <div class="col-md-6 col-xl-3">
                <a class="card card-link" href="#">
                  <div
                    class="card-cover card-cover-blurred text-center"
              ...
              <div class="col-md-6 col-xl-3">
                <a class="card card-link" href="#">
                  <div
                    class="card-cover card-cover-blurred text-center card-cover-blurred"
                  ...
                  <div class="card-body">
                    <div class="row g-2 align-items-center">
                      ...
                      <div class="col">
                        ...
                        <div class="text-secondary">Working in Tabler</div>
                        <div class="small mt-1"><span class="badge bg-green"></span> Online</div>
                      </div>
                      <div class="col-auto">
                  ...
                  <div class="card-body">
                    <div class="row g-2 align-items-center">
                      ...
                      <div class="col">
                        ...
                        <div class="text-secondary">Working in Kare</div>
                        <div class="small mt-1"><span class="badge bg-green"></span> Online</div>
                      </div>
                      <div class="col-auto">
                        <a href="#" class="btn"> Subscribe </a>
              ...
              <div class="col-md-6 col-xl-3">
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <span class="bg-red text-white avatar avatar-square"
                          ><!-- Download SVG icon from http://tabler.io/icons/icon/user -->
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                      ...
                      <div class="col">
                        <div class="fw-medium">1352 Members</div>
                        <div class="text-secondary">163 registered today</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xl-3">
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col-auto">
                        <span class="bg-yellow text-white avatar avatar-square"
                      ...
                      <div class="col">
                        <div class="fw-medium">132 Comments</div>
                        <div class="text-secondary">16 waitings</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="fw-medium">
                          $5,256.99
                          <span class="float-end fw-medium text-green">+4%</span>
                        </div>
                        <div class="text-secondary">Revenue last 30 days</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="fw-medium">
                          342
                          <span class="float-end fw-medium text-red">-4.3%</span>
                        </div>
                        <div class="text-secondary">Sales last 30 days</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="fw-medium">
                          132
                          <span class="float-end fw-medium text-green">+6.8%</span>
                        </div>
                        <div class="text-secondary">Customers last 30 days</div>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      ...
                      <div class="col">
                        <div class="fw-medium">
                          78
                          <span class="float-end fw-medium text-red">-2%</span>
                        </div>
                        <div class="text-secondary">Members registered today</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row row-cards">
                          ...
                          <div class="col">
                            <div class="fw-medium">
                              ...
                              <svg
                                ...
                                aria-hidden="true"
                                focusable="false"
                                class="icon icon-sm ms-1 text-red icon-3"
                              >
                  ...
                  <div class="col-12">
                    <div class="card">
                      ...
                      <div class="card-code">.card-footer { background: transparent; &:last-child { border-radius: 0 0 1 2; } }</div>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div class="card-body p-4 py-5 text-center">
                        ...
                        <div>
                          <div class="avatar-list avatar-list-stacked">
                            <span class="avatar avatar-3" style="background-image: url(./static/avatars/000m.jpg)"> </span>
                            <span class="avatar avatar-3" style="background-image: url(./static/avatars/052f.jpg)"> </span>
                            <span class="avatar avatar-3" style="background-image: url(./static/avatars/002m.jpg)"> </span>
                            <span class="avatar avatar-3" style="background-image: url(./static/avatars/003m.jpg)"> </span>
                            <span class="avatar avatar-3" style="background-image: url(./static/avatars/000f.jpg)"> </span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <div class="avatar-list avatar-list-stacked mb-3">
                          <span class="avatar avatar-4" style="background-image: url(./static/avatars/000m.jpg)"> </span>
                          <span class="avatar avatar-4" style="background-image: url(./static/avatars/052f.jpg)"> </span>
                          <span class="avatar avatar-4" style="background-image: url(./static/avatars/002m.jpg)"> </span>
                          <span class="avatar avatar-4" style="background-image: url(./static/avatars/003m.jpg)"> </span>
                        </div>
                  ...
                  <div class="col-12">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <div class="avatar-list avatar-list-stacked mb-3">
                          <span class="avatar avatar-4" style="background-image: url(./static/avatars/009f.jpg)"> </span>
                          <span class="avatar avatar-4" style="background-image: url(./static/avatars/010f.jpg)"> </span>
                          <span class="avatar avatar-4" style="background-image: url(./static/avatars/011m.jpg)"> </span>
                          <span class="avatar avatar-4" style="background-image: url(./static/avatars/012m.jpg)"> </span>
                          <span class="avatar avatar-4" style="background-image: url(./static/avatars/011f.jpg)"> </span>
                          <span class="avatar avatar-4" style="background-image: url(./static/avatars/012f.jpg)"> </span>
                          <span class="avatar avatar-4" style="background-image: url(./static/avatars/013m.jpg)"> </span>
                        </div>
                        <div class="card-meta d-flex justify-content-between">
                          <div class="d-flex align-items-center">
                            <!-- Download SVG icon from http://tabler.io/icons/icon/check -->
                    ...
                    <div class="card">
                      <div class="card-header">
                        ...
                        <div class="card-actions">
                          <a href="#">
                            Edit configuration<!-- Download SVG icon from http://tabler.io/icons/icon/edit -->
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              width="24"
                              height="24"
                      ...
                      <div class="card-body">
                        <dl class="row">
                          ...
                          <dd class="col-7"><span class="flag flag-xxs flag-country-pl"></span> Poland</dd>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("sparkline-sales"), {
            chart: {
              type: "radialBar",
              fontFamily: "inherit",
              height: 40,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("sparkline-members"), {
            chart: {
              type: "radialBar",
              fontFamily: "inherit",
              height: 40,
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("sparkline-comments"), {
            chart: {
              type: "radialBar",
              fontFamily: "inherit",
              height: 40,
