  ...
  <body>
                    ...
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item active" href="/maps" aria-current="page"> Map </a>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        new mapboxgl.Marker({ color: "var(--tblr-primary)" }).setLngLat([-58.666667, -34.58333333]).addTo(map);
        new mapboxgl.Marker({ color: "var(--tblr-primary)" }).setLngLat([16.366667, 48.2]).addTo(map);
        new mapboxgl.Marker({ color: "var(--tblr-primary)" }).setLngLat([116.383333, 39.91666667]).addTo(map);
        new mapboxgl.Marker({ color: "var(--tblr-primary)" }).setLngLat([149.133333, -35.26666667]).addTo(map);
        new mapboxgl.Marker({ color: "var(--tblr-primary)" }).setLngLat([58.583333, 23.61666667]).addTo(map);
        new mapboxgl.Marker({ color: "var(--tblr-primary)" }).setLngLat([-77, 38.883333]).addTo(map);
      });
    </script>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
