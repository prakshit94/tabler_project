...
<html lang="en">
  <head>
    ...
    <link href="/tabler/dist/libs/jsvectormap/dist/jsvectormap.css?1777289132" rel="stylesheet" />
    <!-- END PAGE LEVEL STYLES -->
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="/tabler/dist/css/tabler.css?1777289132" rel="stylesheet" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PLUGINS STYLES -->
    <link href="/tabler/dist/css/tabler-flags.css?1777289132" rel="stylesheet" />
    <link href="/tabler/dist/css/tabler-socials.css?1777289132" rel="stylesheet" />
    <link href="/tabler/dist/css/tabler-payments.css?1777289132" rel="stylesheet" />
    <link href="/tabler/dist/css/tabler-vendors.css?1777289132" rel="stylesheet" />
    <link href="/tabler/dist/css/tabler-marketing.css?1777289132" rel="stylesheet" />
    <link href="/tabler/dist/css/tabler-themes.css?1777289132" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
    <link href="./preview/css/demo.css?1777289132" rel="stylesheet" />
    <!-- END DEMO STYLES -->
    <!-- BEGIN CUSTOM FONT -->
    <style>
  ...
  <body>
    ...
    <script src="/tabler/dist/js/tabler-theme.min.js?1777289132"></script>
                  ...
                  >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"
                      ...
                      <svg
                        ...
                        class="icon icon-1"
                      >
                        <path d="M12 17.75l-6.172 3.245l1.179 -6.873l-5 -4.867l6.9 -1l3.086 -6.253l3.086 6.253l6.9 1l-5 4.867l1.179 6.873l-6.158 -3.245" /></svg
                    ></span>
                ...
                <li class="nav-item active dropdown">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      ...
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item active" href="/layout-navbar-overlap" aria-current="page"> Navbar overlap </a>
          ...
          <div class="container-xl">
            <div class="row g-2 align-items-center">
              <div class="col">
                ...
                <h1 class="page-title">Navbar overlap layout</h1>
              </div>
              <!-- Page title actions -->
              <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                  <span class="d-none d-sm-inline">
                    <a href="#" class="btn btn-dark btn-2"> New view </a>
                  </span>
                  ...
                  <div class="col-sm-6 col-lg-3">
                    <div class="card card-sm">
                      <div class="card-body">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="bg-primary text-white avatar avatar-square"
                  ...
                  <div class="col-sm-6 col-lg-3">
                    <div class="card card-sm">
                      <div class="card-body">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="bg-green text-white avatar avatar-square"
                  ...
                  <div class="col-sm-6 col-lg-3">
                    <div class="card card-sm">
                      <div class="card-body">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="bg-x text-white avatar avatar-square"
                  ...
                  <div class="col-sm-6 col-lg-3">
                    <div class="card card-sm">
                      <div class="card-body">
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <span class="bg-facebook text-white avatar avatar-square"
                    ...
                    <div class="row align-items-center">
                      <div class="col-10">
                        ...
                        <div class="prose">
                          ...
                          <a href="https://tabler.io/icons" target="_blank" rel="noopener">Tabler Icons Website</a>, download any of the 5986 icons in SVG, PNG
                    ...
                    <table class="table table-selectable card-table table-vcenter text-nowrap datatable">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><a href="/invoice" class="text-reset" tabindex="-1">Design Works</a></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td><a href="/invoice" class="text-reset" tabindex="-1">UX Wireframes</a></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td><a href="/invoice" class="text-reset" tabindex="-1">New Dashboard</a></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td><a href="/invoice" class="text-reset" tabindex="-1">Landing Page</a></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td><a href="/invoice" class="text-reset" tabindex="-1">Marketing Templates</a></td>
                          <td>
                        ...
                        <tr>
                          ...
                          <td><a href="/invoice" class="text-reset" tabindex="-1">Sales Presentation</a></td>
                          <td>
                            <span class="flag flag-xs flag-country-br me-2"></span>
                            Tabdaq
                          </td>
                        ...
                        <tr>
                          ...
                          <td><a href="/invoice" class="text-reset" tabindex="-1">Logo & Print</a></td>
                          <td>
                            <span class="flag flag-xs flag-country-us me-2"></span>
                            Apple
                          </td>
                        ...
                        <tr>
                          ...
                          <td><a href="/invoice" class="text-reset" tabindex="-1">Icons</a></td>
                          <td>
                            <span class="flag flag-xs flag-country-pl me-2"></span>
                            Tookapic
                          </td>
    ...
    <script src="/tabler/dist/libs/apexcharts/dist/apexcharts.min.js?1777289132" defer></script>
    <script src="/tabler/dist/libs/jsvectormap/dist/jsvectormap.min.js?1777289132" defer></script>
    <script src="/tabler/dist/libs/jsvectormap/dist/maps/world.js?1777289132" defer></script>
    <script src="/tabler/dist/libs/jsvectormap/dist/maps/world-merc.js?1777289132" defer></script>
    <!-- END PAGE LIBRARIES -->
    <!-- BEGIN GLOBAL MANDATORY SCRIPTS -->
    <script src="/tabler/dist/js/tabler.min.js?1777289132" defer></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <!-- BEGIN DEMO SCRIPTS -->
    <script src="./preview/js/demo.min.js?1777289132" defer></script>
    <!-- END DEMO SCRIPTS -->
    <!-- BEGIN PAGE SCRIPTS -->
    <style>
      :root {
      ...
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-revenue-bg"), {
            ...
            fill: {
              colors: ["var(--chart-revenue-bg-fill-0)", "var(--chart-revenue-bg-fill-1)"],
              type: "solid",
            },
            stroke: {
              width: 2,
      ...
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-development-activity"), {
            ...
            fill: {
              colors: ["var(--chart-development-activity-fill-0)", "var(--chart-development-activity-fill-1)"],
              type: "solid",
            },
            stroke: {
              width: 2,
