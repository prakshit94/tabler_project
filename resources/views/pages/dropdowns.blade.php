                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                              ...
                              <a class="dropdown-item active" href="/dropdowns" aria-current="page"> Dropdowns </a>
                              <div class="dropend">
                                <a
                                  class="dropdown-item dropdown-toggle"
                                  href="#sidebar-error"
            ...
            <div class="row">
              <div class="col-sm-6 col-lg-3">
                <div class="dropdown-menu dropdown-menu-demo">
                  ...
                  <div class="dropdown-divider"></div>
                  <a href="#" class="dropdown-item"
                    ><span class="avatar avatar-xs rounded me-2" style="background-image: url(./static/avatars/000m.jpg)"> </span> Paweł Kuna</a
                  >
                  <a href="#" class="dropdown-item"
                    ><span class="avatar avatar-xs rounded me-2" style="background-image: url(./static/avatars/052f.jpg)"> </span> Jeffie Lewzey</a
                  >
                  <a href="#" class="dropdown-item"
                    ><span class="avatar avatar-xs rounded me-2" style="background-image: url(./static/avatars/002m.jpg)"> </span> Mallory Hulme</a
                  >
                  <div class="dropdown-divider"></div>
                  <a href="#" class="dropdown-item"
              ...
              <div class="col-sm-6 col-lg-3">
                ...
                <div class="dropdown-menu dropdown-menu-demo">
                  <a href="#" class="dropdown-item"
                    ><span class="avatar avatar-xs" style="background-image: url(./static/avatars/000m.jpg)"> </span> Paweł Kuna</a
                  >
                  <a href="#" class="dropdown-item"
                    ><span class="avatar avatar-xs" style="background-image: url(./static/avatars/052f.jpg)"> </span> Jeffie Lewzey</a
                  >
                  <a href="#" class="dropdown-item"
                    ><span class="avatar avatar-xs" style="background-image: url(./static/avatars/002m.jpg)"> </span> Mallory Hulme</a
                  >
                  <a href="#" class="dropdown-item"
                    ><span class="avatar avatar-xs" style="background-image: url(./static/avatars/003m.jpg)"> </span> Dunn Slane</a
                  >
                  <a href="#" class="dropdown-item"
                    ><span class="avatar avatar-xs" style="background-image: url(./static/avatars/000f.jpg)"> </span> Emmy Levet</a
                  >
                </div>
                <div class="dropdown-menu dropdown-menu-demo">
                  <a href="#" class="dropdown-item"><span class="flag flag-xs flag-country-us"></span> United States</a>
                  <a href="#" class="dropdown-item"><span class="flag flag-xs flag-country-gb"></span> United Kingdom</a>
                  <a href="#" class="dropdown-item"><span class="flag flag-xs flag-country-de"></span> Germany</a>
                  <a href="#" class="dropdown-item"><span class="flag flag-xs flag-country-fr"></span> France</a>
                  <a href="#" class="dropdown-item"><span class="flag flag-xs flag-country-pl"></span> Poland</a>
                </div>
              </div>
            </div>
          </div>
