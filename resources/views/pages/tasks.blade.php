...
<html lang="en">
  <head>
    ...
    <link href="/tabler/dist/css/tabler.css?1777289128" rel="stylesheet" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <!-- BEGIN PLUGINS STYLES -->
    <link href="/tabler/dist/css/tabler-flags.css?1777289128" rel="stylesheet" />
    <link href="/tabler/dist/css/tabler-socials.css?1777289128" rel="stylesheet" />
    <link href="/tabler/dist/css/tabler-payments.css?1777289128" rel="stylesheet" />
    <link href="/tabler/dist/css/tabler-vendors.css?1777289128" rel="stylesheet" />
    <link href="/tabler/dist/css/tabler-marketing.css?1777289128" rel="stylesheet" />
    <link href="/tabler/dist/css/tabler-themes.css?1777289128" rel="stylesheet" />
    <!-- END PLUGINS STYLES -->
    <!-- BEGIN DEMO STYLES -->
    <link href="./preview/css/demo.css?1777289128" rel="stylesheet" />
    <!-- END DEMO STYLES -->
    <!-- BEGIN CUSTOM FONT -->
    <style>
  ...
  <body>
        ...
        <div class="page-header d-print-none">
          <div class="container-xl">
            <div class="row g-2 align-items-center">
              <div class="col">
                <h1 class="page-title">Tabler Inc. Tasks</h1>
              </div>
              <!-- Page title actions -->
                  ...
                  <div class="row row-cards">
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Improve email marketing strategy</h3>
                          <div class="ratio ratio-16x9">
                            <img src="/tabler/static/projects/dashboard-1.png" class="rounded object-cover" alt="Improve email marketing strategy" />
                          </div>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Develop new product video</h3>
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        ...
                        <div class="card-body">
                          <h3 class="card-title">Conduct user interviews for new feature</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col"></div>
                              <div class="col-auto text-secondary">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Create social media content calendar</h3>
                          <div class="text-secondary">Plan and schedule social media posts for Q3</div>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Review and update documentation</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Plan quarterly team meeting</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Redesign product landing page</h3>
                          <div class="text-secondary">Complete redesign based on user feedback</div>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                  ...
                  <div class="row row-cards">
                    <div class="col-12">
                      <div class="card card-sm">
                        ...
                        <div class="card-body">
                          <h3 class="card-title">Implement new analytics tracking</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col"></div>
                              <div class="col-auto text-secondary">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        ...
                        <div class="card-body">
                          <h3 class="card-title">Design new marketing campaign</h3>
                          <div class="text-secondary">Dedicated form for a category of users that will perform actions.</div>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Conduct A/B testing on landing page</h3>
                          <div class="ratio ratio-16x9">
                            <img src="/tabler/static/projects/dashboard-3.png" class="rounded object-cover" alt="Conduct A/B testing on landing page" />
                          </div>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col"></div>
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        ...
                        <div class="card-body">
                          <h3 class="card-title">Implement user authentication system</h3>
                          <div class="text-secondary">Add OAuth and JWT authentication</div>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Write blog post about product launch</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        ...
                        <div class="card-body">
                          <h3 class="card-title">Update customer onboarding flow</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        ...
                        <div class="card-body">
                          <h3 class="card-title">Setup automated testing pipeline</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                          ...
                          <div class="divide-y-2 mt-4">
                            <div>
                              ...
                              <span class="text-secondary text-decoration-line-through">Configure CI/CD</span>
                            </div>
                            <div>
                              <!-- Download SVG icon from http://tabler.io/icons/icon/check -->
                              <svg
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Review customer support tickets</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                ...
                <div class="mb-4">
                  <div class="row row-cards">
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Optimize website performance</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Develop mobile app prototype</h3>
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Conduct user research interviews</h3>
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Migrate database to new server</h3>
                          <div class="text-secondary">Complete database migration with zero downtime</div>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Launch new marketing website</h3>
                          <div class="ratio ratio-16x9">
                            <img src="/tabler/static/projects/dashboard-2.png" class="rounded object-cover" alt="Launch new marketing website" />
                          </div>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-status-top bg-red"></div>
                        <div class="card-body">
                          <h3 class="card-title">Complete annual security audit</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Design new company logo</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Write technical documentation</h3>
                          <div class="text-secondary">Document all API endpoints and integrations</div>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                          ...
                          <div class="divide-y-2 mt-4">
                            <div>
                              ...
                              <span class="text-secondary text-decoration-line-through">Document REST API</span>
                            </div>
                            <div>
                              <!-- Download SVG icon from http://tabler.io/icons/icon/check -->
                              <svg
                              ...
                              <span class="text-secondary text-decoration-line-through">Document GraphQL API</span>
                            </div>
                            <div>
                              <!-- Download SVG icon from http://tabler.io/icons/icon/check -->
                              <svg
                    ...
                    <div class="col-12">
                      <div class="card card-sm">
                        <div class="card-body">
                          <h3 class="card-title">Organize team building event</h3>
                          <div class="mt-4">
                            <div class="row">
                              <div class="col">
                                <div class="avatar-list avatar-list-stacked">
                                  ...
                                  <span class="avatar avatar-xs" style="background-image: url(./static/avatars/009f.jpg)"> </span>
                                  <span class="avatar avatar-xs" style="background-image: url(./static/avatars/010f.jpg)"> </span>
                                  <span class="avatar avatar-xs" style="background-image: url(./static/avatars/011m.jpg)"> </span>
                                  <span class="avatar avatar-xs" style="background-image: url(./static/avatars/012m.jpg)"> </span>
                                </div>
                              </div>
                              <div class="col-auto text-secondary">
                                <button class="switch-icon switch-icon-scale active" data-bs-toggle="switch-icon">
    ...
    <script src="/tabler/dist/js/tabler.min.js?1777289129" defer></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <!-- BEGIN DEMO SCRIPTS -->
    <script src="./preview/js/demo.min.js?1777289129" defer></script>
    <!-- END DEMO SCRIPTS -->
    <!-- BEGIN PAGE SCRIPTS -->
    <script>
      /*
