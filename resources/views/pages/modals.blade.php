                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                              ...
                              <a class="dropdown-item active" href="/modals" aria-current="page"> Modals </a>
                  ...
                  <div class="col">
                    <div class="space-y-6">
                      <div>
                        ...
                        <!-- BEGIN MODAL -->
                        <div
                          class="modal modal-blur fade position-relative rounded d-block bg-surface-backdrop py-6 w-auto h-auto z-0 show"
                          id="modal-simple"
                          tabindex="-1"
                          role="dialog"
                          aria-hidden="false"
                        >
                          <div class="modal-dialog modal-4 modal-dialog-centered" role="document">
                      ...
                      <div>
                        ...
                        <div
                          ...
                          aria-hidden="false"
                        >
                          <div class="modal-dialog modal-6 modal-dialog-centered modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <div class="row mb-3 align-items-end">
                                  <div class="col-auto">
                                    <a href="#" class="avatar avatar-upload rounded avatar-xl">
                                      <!-- Download SVG icon from http://tabler.io/icons/icon/plus -->
                                      <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form>
                                  ...
                                  <div class="row">
                                    <div class="col">
                                      <div class="mb-4">
                                        ...
                                        <div class="input-icon">
                                          <input class="form-control" placeholder="Select a date" id="datepicker-event-start" value="2020-06-20" />
                                    ...
                                    <div class="col">
                                      <div class="mb-4">
                                        ...
                                        <div class="input-icon">
                                          <input class="form-control" placeholder="Select a date" id="datepicker-event-end" value="2020-06-20" />
                                          <span class="input-icon-addon"
                                            ><!-- Download SVG icon from http://tabler.io/icons/icon/calendar -->
                                            <svg
                                              xmlns="http://www.w3.org/2000/svg"
                                  ...
                                  <a href="#" type="submit" class="btn btn-primary btn-5 mt-4 w-100"> Create event </a>
                                </form>
                              </div>
                            </div>
                          </div>
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="mb-4">
                                        ...
                                        <select class="form-select" id="select-task-assigned" value="">
                                          <option
                                            value="1"
...
&lt;/span&gt;"
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                      <div class="mb-4">
                                        ...
                                        <div class="input-icon">
                                          <input class="form-control" placeholder="Select a date" id="datepicker-task-due-date" value="2020-06-20" />
                                          <span class="input-icon-addon"
                                            ><!-- Download SVG icon from http://tabler.io/icons/icon/calendar -->
                                            <svg
                                              xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div class="col-md-6">
                                      <div class="mb-4">
                                        ...
                                        <select class="form-select" id="select-task-category" value="" multiple>
                                  ...
                                  <a href="#" type="submit" class="btn btn-primary btn-5 mt-4 w-100"> Create task </a>
                                </form>
                              </div>
                            </div>
                          </div>
                                ...
                                <form>
                                  <div class="mb-4">
                                    <div class="row align-items-end">
                                      <div class="col-auto">
                                        <a href="#" class="avatar avatar-upload rounded avatar-lg">
                                          <!-- Download SVG icon from http://tabler.io/icons/icon/plus -->
                                          <svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            width="24"
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                      <div class="mb-4">
                                        ...
                                        <div class="input-icon">
                                          <input class="form-control" placeholder="Select a date" id="datepicker-profile-birthdate" value="2020-06-20" />
                                          <span class="input-icon-addon"
                                            ><!-- Download SVG icon from http://tabler.io/icons/icon/calendar -->
                                            <svg
                                              xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <div class="input-group">
                                          <span class="input-group-text"
                                            ...
                                            >
                                              ...
                                              <path d="M3 7a4 4 0 0 1 4 -4h10a4 4 0 0 1 4 4v10a4 4 0 0 1 -4 4h-10a4 4 0 0 1 -4 -4l0 -10" /></svg
                                          ></span>
                                  ...
                                  <a href="#" type="submit" class="btn btn-primary btn-5 mt-4 w-100"> Save changes </a>
                                </form>
                              </div>
                            </div>
                          </div>
                              ...
                              <div class="modal-body">
                                <form>
                                  ...
                                  <div class="mb-4">
                                    ...
                                    <div class="input-group input-group-flat">
                                      <input type="password" class="form-control" placeholder="Enter new password" autocomplete="off" id="password-new" />
                                      <span class="input-group-text">
                                        <a href="#" class="link-secondary" title="Show password" data-bs-toggle="tooltip"
                                          ><!-- Download SVG icon from http://tabler.io/icons/icon/eye -->
                                          <svg
                                  ...
                                  <a href="#" type="submit" class="btn btn-primary btn-5 mt-4 w-100"> Update password </a>
                                </form>
                              </div>
                            </div>
                          </div>
                                ...
                                <form>
                                  ...
                                  <div class="mb-3">
                                    ...
                                    <select class="form-select">
                                      ...
                                      <option value="5">Emmy Levet</option>
                                      <option value="6">Maryjo Lebarree</option>
                                      <option value="2">Jeffie Lewzey</option>
                                      <option value="3">Mallory Hulme</option>
                                    </select>
                                  </div>
                                  <div class="mb-3">
    ...
    <script src="/tabler/dist/libs/litepicker/dist/litepicker.js?1777289128" defer></script>
    <script src="/tabler/dist/libs/hugerte/hugerte.min.js?1777289128" defer></script>
    <script src="/tabler/dist/libs/signature_pad/dist/signature_pad.umd.min.js?1777289128" defer></script>
    <!-- END PAGE LIBRARIES -->
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        if (canvas) {
          ...
          document.querySelector("#signature-default-clear").addEventListener("click", function () {
            signaturePad.clear();
          });
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        let options = {
          selector: "#hugerte-email-message",
          height: 300,
          menubar: false,
          statusbar: false,
          plugins: [
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.Litepicker &&
          new Litepicker({
            element: document.getElementById("datepicker-event-start"),
            buttonText: {
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.Litepicker &&
          new Litepicker({
            element: document.getElementById("datepicker-event-end"),
            buttonText: {
              previousMonth: `<!-- Download SVG icon from http://tabler.io/icons/icon/chevron-left -->
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-1"><path d="M15 6l-6 6l6 6" /></svg>`,
              nextMonth: `<!-- Download SVG icon from http://tabler.io/icons/icon/chevron-right -->
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        var el;
        window.TomSelect &&
          new TomSelect((el = document.getElementById("select-task-assigned")), {
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.Litepicker &&
          new Litepicker({
            element: document.getElementById("datepicker-task-due-date"),
            buttonText: {
              previousMonth: `<!-- Download SVG icon from http://tabler.io/icons/icon/chevron-left -->
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-1"><path d="M15 6l-6 6l6 6" /></svg>`,
              nextMonth: `<!-- Download SVG icon from http://tabler.io/icons/icon/chevron-right -->
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        var el;
        window.TomSelect &&
          new TomSelect((el = document.getElementById("select-task-category")), {
            copyClassesToDropdown: false,
            dropdownParent: "body",
            controlInput: "<input>",
            render: {
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.Litepicker &&
          new Litepicker({
            element: document.getElementById("datepicker-profile-birthdate"),
            buttonText: {
              previousMonth: `<!-- Download SVG icon from http://tabler.io/icons/icon/chevron-left -->
	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false" class="icon icon-1"><path d="M15 6l-6 6l6 6" /></svg>`,
              nextMonth: `<!-- Download SVG icon from http://tabler.io/icons/icon/chevron-right -->
