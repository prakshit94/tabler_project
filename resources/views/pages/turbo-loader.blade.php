...
<html lang="en">
  <head>
    ...
    <script src="/tabler/dist/libs/@hotwired/turbo/dist/turbo.es2017-umd.js?1777289128" defer></script>
    <!-- END PAGE LIBRARIES -->
    <!-- BEGIN CUSTOM FONT -->
    <style>
                    ...
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item active" href="/turbo-loader" aria-current="page"> Turbo loader </a>
