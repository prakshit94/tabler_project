...
<html lang="en">
  <head>
    ...
    <title>Form layout - Tabler - Premium and Open Source dashboard template with responsive and high quality UI.</title>
  ...
  <body>
                    ...
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item active" href="/form-layout" aria-current="page">
                            Form layouts
                            <span class="badge badge-sm bg-green-lt text-uppercase ms-auto">New</span>
                          </a>
                        </div>
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <form class="space-y">
                          ...
                          <div>
                            <a href="#" class="btn btn-primary btn-3 w-100"> Submit </a>
                          </div>
                        </form>
                      </div>
                    </div>
              ...
              <div class="col">
                <div class="row row-cards">
                        ...
                        <form class="space-y">
                          ...
                          <div>
                            <div class="input-icon">
                              ...
                              <input type="mail" value="" class="form-control" placeholder="Email address" />
                            </div>
                          </div>
                          <div>
                            <div class="input-icon">
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h3 class="card-title">Form with Icons and Validation</h3>
                      </div>
                      <div class="card-body">
                        <form class="space-y">
                          <div>
                          ...
                          <div class="space-y">
                            ...
                            <div class="row row-cols-2 g-4">
                              ...
                              <div>
                                ...
                                <div>
                                  <div class="input-icon">
                                    <input class="form-control" placeholder="Select a date" id="datepicker-birth-date" value="2020-06-20" />
                                    <span class="input-icon-addon"
                              ...
                              <div>
                                ...
                                <div>
                                  <select class="form-select">
                                    ...
                                    <option>Federate States of Micronesia</option>
                                    ...
                                    <option>Macao</option>
                                    <option>Nothern Mariana Islands</option>
                                    ...
                                    <option>United States Minor Islands</option>
                            ...
                            <div class="text-end">
                              ...
                              <a href="#" class="btn btn-primary btn-2"> Save Changes </a>
                            </div>
                          </div>
                        </form>
                      </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.Litepicker &&
          new Litepicker({
            element: document.getElementById("datepicker-birth-date"),
            buttonText: {
