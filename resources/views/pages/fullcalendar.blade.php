...
<html lang="en">
  <head>
    ...
    <title>Fullcalendar - Tabler - Premium and Open Source dashboard template with responsive and high quality UI.</title>
  ...
  <body>
                    ...
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item active" href="/fullcalendar" aria-current="page"> Fullcalendar </a>
        ...
        <div class="page-header d-print-none">
          <div class="container-xl">
            <div class="row g-2 align-items-center">
              <div class="col">
                <h1 class="page-title">Fullcalendar</h1>
              </div>
            </div>
          </div>
        </div>
    ...
    <script src="/tabler/dist/libs/fullcalendar/index.global.min.js?1777289128" defer></script>
    <!-- END PAGE LIBRARIES -->
