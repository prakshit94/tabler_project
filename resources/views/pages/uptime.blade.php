...
<html lang="en">
  ...
  <body>
                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            ...
                            <div class="dropdown-menu-column">
                              ...
                              <a class="dropdown-item active" href="/uptime" aria-current="page"> Uptime monitor </a>
              ...
              <div class="col-md-8">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div id="chart-uptime" class="position-relative"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="card">
                  <div class="card-body">
                    ...
                    <div id="chart-uptime-incidents" class="position-relative"></div>
                  </div>
                </div>
              </div>
              <div class="col-12">
    ...
    <script src="/tabler/dist/libs/apexcharts/dist/apexcharts.min.js?1777289129" defer></script>
    <!-- END PAGE LIBRARIES -->
    ...
    <style>
      :root {
        --chart-uptime-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-uptime-fill-0: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
        --chart-uptime-fill-1: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-uptime"), {
            chart: {
              type: "area",
              fontFamily: "inherit",
              height: 240,
            ...
            fill: {
              colors: ["var(--chart-uptime-fill-0)", "var(--chart-uptime-fill-1)"],
              type: "solid",
            },
            stroke: {
              width: 2,
            ...
            series: [
              {
                name: "Uptime",
                data: [
                  150, 160, 170, 161, 167, 162, 161, 152, 141, 144, 154, 166, 176, 187, 198, 210, 196, 207, 200, 187, 192, 204, 193, 204, 208, 196, 193, 178,
                  191, 204, 218, 211, 218, 216, 201, 197, 190, 179, 172, 158, 159, 147, 152, 152, 144, 137, 136, 123, 112, 99, 100, 95, 105, 116, 125, 124, 133,
                  129, 116, 119, 109, 114, 115, 111, 96, 104, 104, 102, 116, 126, 117, 130, 124, 126, 131, 143, 130, 116, 118, 122, 132, 126, 136, 123, 112,
                  116, 113, 113, 109, 99, 100, 95, 83, 79, 64, 79, 81, 94, 99, 97, 83, 71, 75, 69, 71, 75, 84, 90, 100, 96, 108, 102, 116, 112, 112, 102, 115,
                  120, 118, 118,
                ],
              },
            ],
            ...
            colors: ["var(--chart-uptime-color-0)"],
            legend: {
              show: false,
            },
          }).render();
    ...
    <style>
      :root {
        --chart-uptime-incidents-color-0: color-mix(in srgb, transparent, var(--tblr-red) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-uptime-incidents"), {
            chart: {
              type: "bar",
              fontFamily: "inherit",
              height: 240,
            ...
            colors: ["var(--chart-uptime-incidents-color-0)"],
            legend: {
              show: false,
            },
          }).render();
