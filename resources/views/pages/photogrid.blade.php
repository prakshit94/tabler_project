                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            ...
                            <div class="dropdown-menu-column">
                              ...
                              <a class="dropdown-item active" href="/photogrid" aria-current="page"> Photogrid </a>
        ...
        <div class="page-header d-print-none">
          <div class="container-xl">
            <div class="row g-2 align-items-center">
              <div class="col">
                <h1 class="page-title">Photogrid</h1>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="row g-2 g-md-3">
                  <div class="col-12">
                    <a data-fslightbox="gallery" href="/tabler/static/photos/group-of-people-brainstorming-and-taking-notes-2.jpg">
                      <!-- Photo -->
                      <div
                        class="img-responsive img-responsive-3x1 rounded-3 border"
                  ...
                  <div class="col-12">
                    <a data-fslightbox="gallery" href="/tabler/static/photos/finances-us-dollars-and-bitcoins-currency-money-3.jpg">
                      <!-- Photo -->
                      <div
                        class="img-responsive img-responsive-4x1 rounded-3 border"
              ...
              <div class="col-lg-6">
                <div class="row g-2 g-md-3">
                  <div class="col-6">
                    <div class="row g-2 g-md-3">
                      <div class="col-6">
                        <a data-fslightbox="gallery" href="/tabler/static/photos/elegant-home-office-with-golden-accessories.jpg">
                          <!-- Photo -->
                          <div
                            class="img-responsive img-responsive-1x1 rounded-3 border"
                  ...
                  <div class="col-12">
                    <a data-fslightbox="gallery" href="/tabler/static/photos/contemporary-black-and-white-home-decor.jpg">
                      <!-- Photo -->
                      <div
                        class="img-responsive img-responsive-4x1 rounded-3 border"
