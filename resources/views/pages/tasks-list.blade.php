...
<html lang="en">
  <head>
    ...
    <title>Task List - Tabler - Premium and Open Source dashboard template with responsive and high quality UI.</title>
  ...
  <body>
          ...
          <div class="container-xl">
            <div class="row">
              <div class="col-12">
                <div class="card mb-4">
                  <div class="card-header">
                    ...
                    <div class="card-actions">
                      <a href="#" class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#modal-add-task">
                    ...
                    <table class="table table-vcenter card-table table-selectable">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <span class="badge bg-yellow-lt text-yellow-lt-fg">Medium</span>
                          </td>
                          <td class="text-end">
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="badge bg-red-lt text-red-lt-fg">High</span>
                          </td>
                          <td class="text-end">
                            <a href="#" class="btn btn-sm"> View </a>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <span class="badge bg-blue-lt text-blue-lt-fg">Low</span>
                          </td>
                          <td class="text-end">
                            <a href="#" class="btn btn-sm"> View </a>
                          </td>
                ...
                <div class="card mb-4">
                  <div class="card-header">
                    <h3 class="card-title mb-0">In Progress</h3>
                    <div class="card-actions">
                      <a href="#" class="btn btn-sm" data-bs-toggle="modal" data-bs-target="#modal-add-task">
                        <!-- Download SVG icon from http://tabler.io/icons/icon/plus -->
                        <svg
                    ...
                    <table class="table table-vcenter card-table table-selectable">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Implement new analytics tracking</td>
                          <td>
                            <div class="d-flex align-items-center">
                              <span class="avatar avatar-xs me-2" style="background-image: url(./static/avatars/052f.jpg)"> </span>
                              <span>Jeffie Lewzey</span>
                        ...
                        <tr>
                          ...
                          <td>Design new marketing campaign</td>
                          <td>
                            <div class="d-flex align-items-center">
                              <span class="avatar avatar-xs me-2" style="background-image: url(./static/avatars/002m.jpg)"> </span>
                              <span>Mallory Hulme</span>
                        ...
                        <tr>
                          ...
                          <td>Conduct A/B testing on landing page</td>
                          <td>
                            <div class="d-flex align-items-center">
                              <span class="avatar avatar-xs me-2" style="background-image: url(./static/avatars/000f.jpg)"> </span>
                              <span>Emmy Levet</span>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              ...
                              <span>Christabel Charlwood</span>
                            </div>
                          </td>
                          <td class="text-secondary">
                            <!-- Download SVG icon from http://tabler.io/icons/icon/calendar -->
                    ...
                    <table class="table table-vcenter card-table table-selectable">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>Optimize website performance</td>
                          <td>
                            <div class="d-flex align-items-center">
                              <span class="avatar avatar-xs me-2" style="background-image: url(./static/avatars/002m.jpg)"> </span>
                              <span>Mallory Hulme</span>
                        ...
                        <tr>
                          ...
                          <td>Develop mobile app prototype</td>
                          <td>
                            <div class="d-flex align-items-center">
                              <span class="avatar avatar-xs me-2" style="background-image: url(./static/avatars/000f.jpg)"> </span>
                              <span>Emmy Levet</span>
                        ...
                        <tr>
                          ...
                          <td>Migrate database to new server</td>
                          <td>
                            <div class="d-flex align-items-center">
                              <span class="avatar avatar-xs me-2"> SA </span>
                              <span>Sunny Airey</span>
                            </div>
                          </td>
                          <td class="text-secondary">
                            <!-- Download SVG icon from http://tabler.io/icons/icon/calendar -->
                        ...
                        <tr>
                          ...
                          <td>Organize team building event</td>
                          <td>
                            <div class="d-flex align-items-center">
                              <span class="avatar avatar-xs me-2"> AA </span>
                              <span>Arlie Armstead</span>
                            </div>
                          </td>
                          <td class="text-secondary">
                            <!-- Download SVG icon from http://tabler.io/icons/icon/calendar -->
    ...
    <!-- BEGIN PAGE MODALS -->
    <div class="modal modal-blur fade" id="modal-add-task" tabindex="-1" role="dialog" aria-hidden="true">
