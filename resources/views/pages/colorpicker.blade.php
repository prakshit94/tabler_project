...
<html lang="en">
  <head>
    ...
    <link href="/tabler/dist/libs/@melloware/coloris/dist/coloris.min.css?1777289127" rel="stylesheet" />
  ...
  <body>
                    ...
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item active" href="/colorpicker" aria-current="page"> Color picker </a>
    ...
    <script src="/tabler/dist/libs/@melloware/coloris/dist/umd/coloris.min.js?1777289128" defer></script>
    <!-- END PAGE LIBRARIES -->
      ...
      document.addEventListener("DOMContentLoaded", function () {
        window.Coloris &&
          Coloris({
            ...
            format: "hex",
            swatches: [
              window.getComputedStyle(document.body).getPropertyValue("--tblr-blue"),
              window.getComputedStyle(document.body).getPropertyValue("--tblr-azure"),
              window.getComputedStyle(document.body).getPropertyValue("--tblr-indigo"),
              window.getComputedStyle(document.body).getPropertyValue("--tblr-purple"),
              window.getComputedStyle(document.body).getPropertyValue("--tblr-pink"),
              window.getComputedStyle(document.body).getPropertyValue("--tblr-red"),
              window.getComputedStyle(document.body).getPropertyValue("--tblr-orange"),
              window.getComputedStyle(document.body).getPropertyValue("--tblr-yellow"),
              window.getComputedStyle(document.body).getPropertyValue("--tblr-lime"),
              window.getComputedStyle(document.body).getPropertyValue("--tblr-green"),
              window.getComputedStyle(document.body).getPropertyValue("--tblr-teal"),
              window.getComputedStyle(document.body).getPropertyValue("--tblr-cyan"),
            ],
          });
      });
    </script>
