...
<html lang="en">
  ...
  <body>
                  ...
                  <nav aria-label="Primary">
                    ...
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu">
                          <a class="dropdown-item active" href="/charts" aria-current="page"> Charts </a>
    ...
    <script src="/tabler/dist/libs/apexcharts/dist/apexcharts.min.js?1777289128" defer></script>
    <!-- END PAGE LIBRARIES -->
            ...
            series: [
              {
                name: "Mobile",
                data: [
                  4164, 4652, 4817, 4841, 4920, 5439, 5486, 5498, 5512, 5538, 5841, 5877, 6086, 6146, 6199, 6431, 6704, 7939, 8127, 8296, 8322, 8389, 8411,
              ...
              },
              {
                name: "Desktop",
                data: [
                  2164, 2292, 2386, 2430, 2528, 3045, 3255, 3295, 3481, 3604, 3688, 3840, 3932, 3949, 4003, 4298, 4424, 4869, 4922, 4973, 5155, 5267, 5566,
              ...
              },
              {
                name: "Tablet",
                data: [
                  1069, 1089, 1125, 1141, 1162, 1179, 1185, 1216, 1274, 1322, 1346, 1395, 1439, 1564, 1581, 1590, 1656, 1815, 1868, 2010, 2133, 2179, 2264,
      ...
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-social-referrals"), {
            ...
            series: [
              {
                name: "Facebook",
                data: [
                  13281, 8521, 15038, 9983, 15417, 8888, 7052, 14270, 5214, 9587, 5950, 16852, 17836, 12217, 17406, 12262, 9147, 14961, 18292, 15230, 13435,
                  10649, 5140, 13680, 4508, 13271, 13413, 5543, 18727, 18238, 18175, 6246, 5864, 17847, 9170, 6445, 12945, 8142, 8980, 10422, 15535, 11569,
              ...
              },
              {
                name: "Twitter",
                data: [
                  3680, 1862, 3070, 2252, 5348, 3091, 3000, 3984, 5176, 5325, 2420, 5474, 3098, 1893, 3748, 2879, 4197, 5186, 4213, 4334, 2807, 1594, 4863,
                  2030, 3752, 4856, 5341, 3954, 3461, 3097, 3404, 4949, 2283, 3227, 3630, 2360, 3477, 4675, 1901, 2252, 3347, 2954, 5029, 2079, 2830, 3292,
              ...
              },
              {
                name: "Dribbble",
                data: [
                  722, 1866, 961, 1108, 1110, 561, 1753, 1815, 1985, 776, 859, 547, 1488, 766, 702, 621, 1599, 1372, 1620, 963, 759, 764, 739, 789, 1696, 1454,
                  1842, 734, 551, 1689, 1924, 1875, 908, 1675, 1541, 1953, 534, 502, 1524, 1867, 719, 1472, 1608, 1025, 889, 1150, 654, 1695, 1662, 1285, 1787,
                ],
              },
            ],
            tooltip: {
            ...
            colors: ["var(--chart-social-referrals-color-0)", "var(--chart-social-referrals-color-1)", "var(--chart-social-referrals-color-2)"],
            legend: {
              show: true,
              position: "bottom",
              offsetY: 12,
    ...
    <style>
      :root {
        --chart-tasks-overview-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
    ...
    <style>
      :root {
        --chart-completion-tasks-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-completion-tasks"), {
            ...
            labels: ["2020-06-20", "2020-06-21", "2020-06-22", "2020-06-23", "2020-06-24", "2020-06-25", "2020-06-26"],
    ...
    <style>
      :root {
        --chart-completion-tasks-2-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
    ...
    <style>
      :root {
        --chart-completion-tasks-3-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-completion-tasks-3-fill-0: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
        --chart-completion-tasks-3-fill-1: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-completion-tasks-3"), {
            ...
            fill: {
              colors: ["var(--chart-completion-tasks-3-fill-0)", "var(--chart-completion-tasks-3-fill-1)"],
              type: "solid",
            },
            stroke: {
              width: 2,
    ...
    <style>
      :root {
        --chart-completion-tasks-4-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-completion-tasks-4"), {
            chart: {
              type: "line",
              fontFamily: "inherit",
              height: 240,
    ...
    <style>
      :root {
        --chart-completion-tasks-5-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-completion-tasks-5"), {
            chart: {
              type: "line",
              fontFamily: "inherit",
              height: 240,
    ...
    <style>
      :root {
        --chart-completion-tasks-6-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-completion-tasks-6"), {
            chart: {
              type: "bar",
              fontFamily: "inherit",
              height: 240,
    ...
    <style>
      :root {
        --chart-completion-tasks-7-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-completion-tasks-7"), {
            chart: {
              type: "line",
              fontFamily: "inherit",
              height: 240,
    ...
    <style>
      :root {
        --chart-completion-tasks-8-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-completion-tasks-8-color-1: color-mix(in srgb, transparent, var(--tblr-red) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-completion-tasks-8"), {
            chart: {
              type: "bar",
              fontFamily: "inherit",
              height: 240,
            ...
            labels: ["2020-06-20", "2020-06-21", "2020-06-22", "2020-06-23", "2020-06-24", "2020-06-25", "2020-06-26"],
            colors: ["var(--chart-completion-tasks-8-color-0)", "var(--chart-completion-tasks-8-color-1)"],
            legend: {
              show: false,
            },
          }).render();
    ...
    <style>
      :root {
        --chart-completion-tasks-9-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-completion-tasks-9-color-1: color-mix(in srgb, transparent, var(--tblr-red) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-completion-tasks-9"), {
            chart: {
              type: "bar",
              fontFamily: "inherit",
              height: 240,
            ...
            labels: ["2020-06-20", "2020-06-21", "2020-06-22", "2020-06-23", "2020-06-24", "2020-06-25", "2020-06-26"],
            colors: ["var(--chart-completion-tasks-9-color-0)", "var(--chart-completion-tasks-9-color-1)"],
            legend: {
              show: false,
            },
          }).render();
    ...
    <style>
      :root {
        --chart-completion-tasks-10-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-completion-tasks-10-color-1: color-mix(in srgb, transparent, var(--tblr-red) 100%);
        --chart-completion-tasks-10-fill-0: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
        --chart-completion-tasks-10-fill-1: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-completion-tasks-10"), {
            ...
            fill: {
              colors: ["var(--chart-completion-tasks-10-fill-0)", "var(--chart-completion-tasks-10-fill-1)"],
              type: "solid",
            },
            stroke: {
              width: 2,
            ...
            labels: ["2020-06-20", "2020-06-21", "2020-06-22", "2020-06-23", "2020-06-24", "2020-06-25", "2020-06-26"],
            colors: ["var(--chart-completion-tasks-10-color-0)", "var(--chart-completion-tasks-10-color-1)"],
            legend: {
              show: false,
            },
          }).render();
    ...
    <style>
      :root {
        --chart-completion-tasks-11-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-completion-tasks-11-color-1: color-mix(in srgb, transparent, var(--tblr-red) 100%);
        --chart-completion-tasks-11-fill-0: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
        --chart-completion-tasks-11-fill-1: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-completion-tasks-11"), {
            chart: {
              type: "area",
              fontFamily: "inherit",
              height: 240,
            ...
            fill: {
              colors: ["var(--chart-completion-tasks-11-fill-0)", "var(--chart-completion-tasks-11-fill-1)"],
              type: "solid",
            },
            stroke: {
              width: 2,
            ...
            labels: ["2020-06-20", "2020-06-21", "2020-06-22", "2020-06-23", "2020-06-24", "2020-06-25", "2020-06-26"],
            colors: ["var(--chart-completion-tasks-11-color-0)", "var(--chart-completion-tasks-11-color-1)"],
            legend: {
              show: false,
            },
          }).render();
    ...
    <style>
      :root {
        --chart-campaigns-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-campaigns-color-1: color-mix(in srgb, transparent, var(--tblr-primary) 80%);
        --chart-campaigns-color-2: color-mix(in srgb, transparent, var(--tblr-primary) 60%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-campaigns"), {
            ...
            colors: ["var(--chart-campaigns-color-0)", "var(--chart-campaigns-color-1)", "var(--chart-campaigns-color-2)"],
            legend: {
              show: false,
            },
          }).render();
    ...
    <style>
      :root {
        --chart-tasks-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-tasks-color-1: color-mix(in srgb, transparent, var(--tblr-lime) 100%);
        --chart-tasks-color-2: color-mix(in srgb, transparent, var(--tblr-orange) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-tasks"), {
            chart: {
              type: "line",
              fontFamily: "inherit",
              height: 240,
            ...
            colors: ["var(--chart-tasks-color-0)", "var(--chart-tasks-color-1)", "var(--chart-tasks-color-2)"],
            legend: {
              show: false,
            },
            tooltip: {
    ...
    <style>
      :root {
        --chart-line-stroke-color-0: color-mix(in srgb, transparent, var(--tblr-orange) 100%);
        --chart-line-stroke-color-1: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-line-stroke-color-2: color-mix(in srgb, transparent, var(--tblr-green) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-line-stroke"), {
            ...
            colors: ["var(--chart-line-stroke-color-0)", "var(--chart-line-stroke-color-1)", "var(--chart-line-stroke-color-2)"],
            legend: {
              show: false,
            },
          }).render();
    ...
    <style>
      :root {
        --chart-stepline-color-0: color-mix(in srgb, transparent, var(--tblr-orange) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-stepline"), {
            chart: {
              type: "line",
              fontFamily: "inherit",
              height: 240,
    ...
    <style>
      :root {
        --chart-temperature-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-temperature-color-1: color-mix(in srgb, transparent, var(--tblr-green) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-temperature"), {
            ...
            colors: ["var(--chart-temperature-color-0)", "var(--chart-temperature-color-1)"],
            legend: {
              show: false,
            },
            markers: {
    ...
    <style>
      :root {
        --chart-area-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-area-color-1: color-mix(in srgb, transparent, var(--tblr-pink) 100%);
        --chart-area-fill-0: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
        --chart-area-fill-1: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
    ...
    <style>
      :root {
        --chart-area-spline-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-area-spline-color-1: color-mix(in srgb, transparent, var(--tblr-pink) 100%);
        --chart-area-spline-fill-0: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
        --chart-area-spline-fill-1: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-area-spline"), {
            chart: {
              type: "area",
              fontFamily: "inherit",
              height: 240,
            ...
            fill: {
              colors: ["var(--chart-area-spline-fill-0)", "var(--chart-area-spline-fill-1)"],
              type: "solid",
            },
            stroke: {
              width: 2,
            ...
            colors: ["var(--chart-area-spline-color-0)", "var(--chart-area-spline-color-1)"],
            legend: {
              show: false,
            },
          }).render();
    ...
    <style>
      :root {
        --chart-area-spline-stacked-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-area-spline-stacked-color-1: color-mix(in srgb, transparent, var(--tblr-pink) 100%);
        --chart-area-spline-stacked-fill-0: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
        --chart-area-spline-stacked-fill-1: color-mix(in srgb, transparent, var(--tblr-primary) 16%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-area-spline-stacked"), {
            chart: {
              type: "area",
              fontFamily: "inherit",
              height: 240,
            ...
            fill: {
              colors: ["var(--chart-area-spline-stacked-fill-0)", "var(--chart-area-spline-stacked-fill-1)"],
              type: "solid",
            },
            stroke: {
              width: 2,
            ...
            colors: ["var(--chart-area-spline-stacked-color-0)", "var(--chart-area-spline-stacked-color-1)"],
            legend: {
              show: false,
            },
          }).render();
    ...
    <style>
      :root {
        --chart-spline-color-0: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
        --chart-spline-color-1: color-mix(in srgb, transparent, var(--tblr-green) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        window.ApexCharts &&
          new ApexCharts(document.getElementById("chart-spline"), {
            chart: {
              type: "line",
              fontFamily: "inherit",
              height: 240,
            ...
            series: [
              {
                name: "Hestavollane",
                data: [
                  0.2, 0.8, 0.8, 0.8, 1, 1.3, 1.5, 2.9, 1.9, 2.6, 1.6, 3, 4, 3.6, 4.5, 4.2, 4.5, 4.5, 4, 3.1, 2.7, 4, 2.7, 2.3, 2.3, 4.1, 7.7, 7.1, 5.6, 6.1,
                  5.8, 8.6, 7.2, 9, 10.9, 11.5, 11.6, 11.1, 12, 12.3, 10.7, 9.4, 9.8, 9.6, 9.8, 9.5, 8.5, 7.4, 7.6,
                ],
              },
              {
                name: "Vik",
                data: [
                  0, 0, 0.6, 0.9, 0.8, 0.2, 0, 0, 0, 0.1, 0.6, 0.7, 0.8, 0.6, 0.2, 0, 0.1, 0.3, 0.3, 0, 0.1, 0, 0, 0, 0.2, 0.1, 0, 0.3, 0, 0.1, 0.2, 0.1, 0.3,
                  0.3, 0, 3.1, 3.1, 2.5, 1.5, 1.9, 2.1, 1, 2.3, 1.9, 1.2, 0.7, 1.3, 0.4, 0.3,
                ],
              },
            ],
            tooltip: {
    ...
    <style>
      :root {
        --chart-combination-color-0: color-mix(in srgb, transparent, var(--tblr-green) 100%);
        --chart-combination-color-1: color-mix(in srgb, transparent, var(--tblr-pink) 100%);
        --chart-combination-color-2: color-mix(in srgb, transparent, var(--tblr-green) 100%);
        --chart-combination-color-3: color-mix(in srgb, transparent, var(--tblr-primary) 100%);
      }
    </style>
    <script>
      document.addEventListener("DOMContentLoaded", function () {
