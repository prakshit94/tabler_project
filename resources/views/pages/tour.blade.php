...
<html lang="en">
  <head>
    ...
    <title>Driver Tour - Tabler - Premium and Open Source dashboard template with responsive and high quality UI.</title>
    <!-- BEGIN PAGE LEVEL STYLES -->
    <link href="/tabler/dist/libs/driver.js/dist/driver.css?1777289127" rel="stylesheet" />
  ...
  <body>
                    ...
                    <ul class="navbar-nav">
                      ...
                      <li class="nav-item active dropdown">
                        ...
                        <div class="dropdown-menu">
                          ...
                          <a class="dropdown-item active" href="/tour" aria-current="page"> Tour </a>
        ...
        <div class="page-header d-print-none">
          <div class="container-xl">
            <div class="row g-2 align-items-center">
              <div class="col">
                <h1 class="page-title">Driver Tour</h1>
              </div>
            </div>
          </div>
        </div>
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-actions">
                      <button id="start-tour" class="btn btn-primary btn-5">Start Tour</button>
                    </div>
                  </div>
                  <div class="card-body">
                    <p>
              ...
              <div class="col-md-6">
                <div class="card" id="tour-card-1">
                  ...
                  <div class="card-body">
                    ...
                    <div class="btn-list">
                      <button class="btn btn-primary btn-3">Action Button</button>
    ...
    <script src="/tabler/dist/libs/driver.js/dist/driver.js.iife.js?1777289128" defer></script>
    <!-- END PAGE LIBRARIES -->
