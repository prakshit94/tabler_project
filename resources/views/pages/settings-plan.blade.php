                ...
                <div class="col-12 col-md-3 border-end">
                  <div class="card-body">
                    ...
                    <nav class="list-group list-group-transparent">
                      <a href="/settings" class="list-group-item list-group-item-action d-flex align-items-center">My Account</a>
                      ...
                      <a href="/settings-plan" class="list-group-item list-group-item-action d-flex align-items-center active">Plans</a>
                    ...
                    <div class="row row-cards">
                      <div class="col-lg-4">
                        <div class="card card-md">
                          <div class="card-body text-center">
                            <div class="text-uppercase text-secondary fw-medium">Free</div>
                      ...
                      <div class="col-lg-4">
                        <div class="card card-md">
                          ...
                          <div class="card-body text-center">
                            <div class="text-uppercase text-secondary fw-medium">Premium</div>
                      ...
                      <div class="col-lg-4">
                        <div class="card card-md">
                          <div class="card-body text-center">
                            <div class="text-uppercase text-secondary fw-medium">Enterprise</div>
                        ...
                        <div class="card card-md">
                          <div class="card-body">
                            <div class="row align-items-center">
                              ...
                              <div class="col-auto">
                                <a href="#" class="btn btn-1"> Book a demo </a>
                              </div>
                            </div>
                          </div>
                        </div>
