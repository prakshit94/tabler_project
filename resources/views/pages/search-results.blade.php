                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            ...
                            <div class="dropdown-menu-column">
                              ...
                              <a class="dropdown-item active" href="/search-results" aria-current="page"> Search results </a>
            ...
            <div class="row g-4">
              ...
              <div class="col-md-9">
                <div class="row row-cards">
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <div class="card card-sm">
                      <a href="#" class="d-block"><img src="/tabler/static/photos/coffee-on-a-table-with-other-items.jpg" class="card-img-top" /></a>
                      <div class="card-body">
                        <div class="d-flex align-items-center">
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <div class="card card-sm">
                      <a href="#" class="d-block"><img src="/tabler/static/photos/young-entrepreneur-working-from-a-modern-cafe-2.jpg" class="card-img-top" /></a>
                      <div class="card-body">
                        <div class="d-flex align-items-center">
                  ...
                  <div class="col-sm-6 col-lg-4">
                    <div class="card card-sm">
                      <a href="#" class="d-block"
                        ><img src="/tabler/static/photos/soft-photo-of-woman-on-the-bed-with-the-book-and-cup-of-coffee-in-hands.jpg" class="card-img-top"
                      /></a>
                      <div class="card-body">
                        <div class="d-flex align-items-center">
