                        ...
                        <div class="dropdown-menu">
                          <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                              ...
                              <a class="dropdown-item active" href="/accordion" aria-current="page">
                                Accordion
                    ...
                    <div class="accordion" id="accordion-default">
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1-default" aria-expanded="true">
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-2-default"
                            aria-expanded="false"
                          >
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-3-default"
                            aria-expanded="false"
                          >
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-4-default"
                            aria-expanded="false"
                          >
              ...
              <div class="col-md-6">
                <div class="card">
                  <div class="accordion accordion-flush" id="accordion-flush">
                    <div class="accordion-item">
                      <div class="accordion-header">
                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1-flush" aria-expanded="true">
                          What makes Tabler different from other UI frameworks?
                          <div class="accordion-button-toggle">
                            <!-- Download SVG icon from http://tabler.io/icons/icon/chevron-down -->
                            <svg
                    ...
                    <div class="accordion-item">
                      <div class="accordion-header">
                        <button
                          ...
                          type="button"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse-2-flush"
                          aria-expanded="false"
                        >
                          How can I customize Tabler components to fit my design needs?
                          <div class="accordion-button-toggle">
                    ...
                    <div class="accordion-item">
                      <div class="accordion-header">
                        <button
                          ...
                          type="button"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse-3-flush"
                          aria-expanded="false"
                        >
                          Is Tabler optimized for performance and fast loading times?
                          <div class="accordion-button-toggle">
                    ...
                    <div class="accordion-item">
                      <div class="accordion-header">
                        <button
                          ...
                          type="button"
                          data-bs-toggle="collapse"
                          data-bs-target="#collapse-4-flush"
                          aria-expanded="false"
                        >
                          How accessible are Tabler components?
                          <div class="accordion-button-toggle">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="accordion accordion-tabs" id="accordion-tabs">
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1-tabs" aria-expanded="true">
                            What makes Tabler different from other UI frameworks?
                            <div class="accordion-button-toggle">
                              <!-- Download SVG icon from http://tabler.io/icons/icon/chevron-down -->
                              <svg
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-2-tabs"
                            aria-expanded="false"
                          >
                            How can I customize Tabler components to fit my design needs?
                            <div class="accordion-button-toggle">
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-3-tabs"
                            aria-expanded="false"
                          >
                            Is Tabler optimized for performance and fast loading times?
                            <div class="accordion-button-toggle">
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-4-tabs"
                            aria-expanded="false"
                          >
                            How accessible are Tabler components?
                            <div class="accordion-button-toggle">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="accordion accordion-inverted" id="accordion-inverted">
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1-inverted" aria-expanded="true">
                            What makes Tabler different from other UI frameworks?
                            <div class="accordion-button-toggle">
                              <!-- Download SVG icon from http://tabler.io/icons/icon/chevron-down -->
                              <svg
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-2-inverted"
                            aria-expanded="false"
                          >
                            How can I customize Tabler components to fit my design needs?
                            <div class="accordion-button-toggle">
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-3-inverted"
                            aria-expanded="false"
                          >
                            Is Tabler optimized for performance and fast loading times?
                            <div class="accordion-button-toggle">
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-4-inverted"
                            aria-expanded="false"
                          >
                            How accessible are Tabler components?
                            <div class="accordion-button-toggle">
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-1-inverted-plus"
                            aria-expanded="true"
                          >
                            What makes Tabler different from other UI frameworks?
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-2-inverted-plus"
                            aria-expanded="false"
                          >
                            How can I customize Tabler components to fit my design needs?
                            <div class="accordion-button-toggle accordion-button-toggle-plus">
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-3-inverted-plus"
                            aria-expanded="false"
                          >
                            Is Tabler optimized for performance and fast loading times?
                            <div class="accordion-button-toggle accordion-button-toggle-plus">
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-4-inverted-plus"
                            aria-expanded="false"
                          >
                            How accessible are Tabler components?
                            <div class="accordion-button-toggle accordion-button-toggle-plus">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="accordion" id="accordion-icons">
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1-icons" aria-expanded="true">
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-2-icons"
                            aria-expanded="false"
                          >
                            <div class="accordion-button-icon">
                              <!-- Download SVG icon from http://tabler.io/icons/icon/link -->
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-3-icons"
                            aria-expanded="false"
                          >
                            <div class="accordion-button-icon">
                              <!-- Download SVG icon from http://tabler.io/icons/icon/link -->
                      ...
                      <div class="accordion-item">
                        <div class="accordion-header">
                          <button
                            ...
                            type="button"
                            data-bs-toggle="collapse"
                            data-bs-target="#collapse-4-icons"
                            aria-expanded="false"
                          >
                            <div class="accordion-button-icon">
                              <!-- Download SVG icon from http://tabler.io/icons/icon/link -->
