...
<html lang="en">
  ...
  <body>
      ...
      <div class="bg-dark bg-cover" style="background-image: url(./static/bg-cover.jpg)">
        <div class="bg-dark bg-opacity-75 pt-5 bg-blur">
          <div class="container container-tight bg-overlay">
            <img src="/tabler/static/bg-cover.jpg" alt="" class="img-fluid rounded-lg rounded-top" />
          </div>
        </div>
      </div>
    ...
    <script src="/tabler/dist/libs/imask/dist/imask.min.js?1777289122" defer></script>
    <!-- END PAGE LIBRARIES -->
